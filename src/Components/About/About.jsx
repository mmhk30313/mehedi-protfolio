  ...
  return (
    <div id="about" className='about'>
      ...
      <div className="row w-100 mx-auto justify-content-center mt-3">
        ...
        <p className='col-md-4 mt-4 text-justify' data-aos="zoom-out-left"><strong className='text-warning'>Passionate web app developer.</strong> Always try to grab the new features of technology. Last few years made myself skilled in the field of web application development. Acquired to maintain strong interpersonal relationships with teammates. I am passionate about providing care to my work, which keeps me motivated and excited about doing my best work</p>
      </div>
      <div className="row w-100 mx-auto container justify-content-center p-3">
          <div className="col-md-6 w-100 mx-auto justify-content-center" data-aos="zoom-in-left">
            <h3 className="pb-1 text-info">PROFILE</h3>
            <h5 className='text-warning'>Name:</h5>
            <p >Md. Mehedi Hasan Khan</p>
            <h5 className='text-warning'>Education:</h5>
            <p className="font-weight-bold">B.Sc. Eng. (Computer Science and Engineering)</p>
              ...
              <h5 className='text-warning'>Nationality:</h5>
              <p>Bangladeshi</p>
          </div>
          <div className="col-md-4 col-sm-12" data-aos="zoom-in-right">
            <h3 className="pb-2 text-info">My Skills Set</h3>
            ...
            <h3 className="text-success">I want to work with</h3>
            <div className="technology mb-3">
